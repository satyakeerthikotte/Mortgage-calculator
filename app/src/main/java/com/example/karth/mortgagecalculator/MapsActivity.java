...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   private GoogleMap mMap;
    ...
    public void onSearch(View view) {
        //EditText location_tadd = (EditText) findViewById(R.id.Taddress);
       // String loc = location_tadd.getText().toString();
        String loc="2907 Creek Point Dr, San Jose, California, 95133";
